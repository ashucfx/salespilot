...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 flex h-screen w-72 flex-col bg-[#05050A] border-r border-border/60 shadow-2xl transition-transform duration-300 ease-in-out lg:static lg:translate-x-0",
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      )}>
        {/* Brand */}
      <div className="flex h-20 shrink-0 items-center px-6 border-b border-border/60 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <span className="text-2xl font-black tracking-tighter text-foreground flex items-center drop-shadow-lg">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive 
                  ? "text-foreground bg-gradient-to-r from-indigo-500/15 to-violet-500/5 shadow-[inset_1px_0_0_0_#6366f1]" 
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  isActive ? "bg-indigo-500/20" : "bg-transparent group-hover:bg-muted"
                )}>
      ...
      {/* User Area */}
      <div className="shrink-0 p-4 border-t border-border/60 bg-[#0A0A10]/50 backdrop-blur-md">
