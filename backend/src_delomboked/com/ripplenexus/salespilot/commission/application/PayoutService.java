...
public class PayoutService {
    ...
    public PayoutDto markAsPaid(UUID payoutId, String paymentRef) {
        Payout payout = payoutRepository.findById(payoutId).orElseThrow(() -> new ResourceNotFoundException("Payout", payoutId));
    ...
    public PayoutService(final PayoutRepository payoutRepository, final EmployeeRepository employeeRepository) {
