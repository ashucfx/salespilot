...
public class AnalyticsService {
    ...
    public Map<String, Object> getAdminDashboard() {
        ...
        stats.put("totalLeads", leadRepository.countByStatus(Lead.LeadStatus.NEW) + leadRepository.countByStatus(Lead.LeadStatus.CONTACTED));
    ...
    public AnalyticsService(final LeadRepository leadRepository, final DealRepository dealRepository, final EmployeeRepository employeeRepository, final CommissionRepository commissionRepository) {
