...
public class ClientForgeService {
    private static final Logger log = LoggerFactory.getLogger(ClientForgeService.class);
    private final DealRepository dealRepository;
    private final EmployeeRepository employeeRepository;
    private final CommissionService commissionService;

    public void pushDealToClientForge(UUID dealId) {
        Deal deal = dealRepository.findById(dealId).orElseThrow(() -> new ResourceNotFoundException("Deal", dealId));
    ...
    public void handleInvoicePaid(InvoicePaidWebhookRequest request) {
        ...
        Deal deal = dealRepository.findById(request.getDealId()).orElseThrow(() -> new ResourceNotFoundException("Deal", request.getDealId()));
    ...
    public ClientForgeService(final DealRepository dealRepository, final EmployeeRepository employeeRepository, final CommissionService commissionService) {
