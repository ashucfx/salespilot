...
public class IncentiveController {
    ...
    @GetMapping("/me")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<List<EmployeeIncentiveDto>>> getMyIncentives(@AuthenticationPrincipal User user) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<EmployeeIncentiveDto>> claimIncentive(@PathVariable UUID incentiveId, @AuthenticationPrincipal User user) {
