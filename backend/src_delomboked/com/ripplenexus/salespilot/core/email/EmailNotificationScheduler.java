...
public class EmailNotificationScheduler {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(EmailNotificationScheduler.class);
        ...
        for (Employee employee : activeEmployees) {
            ...
            if (employee.getStatus() == Employee.EmploymentStatus.ACTIVE) {
                try {
                    ...
                    int todayMeetings = 2;
                    emailService.sendDailyAgendaEmail(employee.getWorkEmail(), employee.getFirstName(), pendingFollowUps, todayMeetings);
                    emailsSent++;
        ...
        for (Employee employee : activeEmployees) {
            ...
            if (employee.getStatus() == Employee.EmploymentStatus.ACTIVE) {
                try {
                    ...
                    emailService.sendWeeklyPerformanceSummaryEmail(employee.getWorkEmail(), employee.getFirstName(), (int) dealsCount, revenue.toString());
                    emailsSent++;
                    Thread.sleep(150);
                } catch (Exception e) {
    ...
    public EmailNotificationScheduler(final EmployeeRepository employeeRepository, final DealRepository dealRepository, final EmailService emailService) {
