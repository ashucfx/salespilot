...
public class ICPService {
    ...
    private IdealCustomerProfile getOrThrow(UUID id) {
        return icpRepository.findById(id).filter(c -> c.getDeletedAt() == null).orElseThrow(() -> new ResourceNotFoundException("IdealCustomerProfile", id));
    }

    @java.lang.SuppressWarnings("all")
    
    public ICPService(final ICPRepository icpRepository) {
