...
public class CompanyService {
    ...
    public Company updateCompany(UUID id, Company request) {
        ...
        if (!company.getName().equalsIgnoreCase(request.getName()) && companyRepository.existsByNameIgnoreCase(request.getName())) {
    ...
    private Company getOrThrow(UUID id) {
        return companyRepository.findById(id).filter(c -> c.getDeletedAt() == null).orElseThrow(() -> new ResourceNotFoundException("Company", id));
    }
