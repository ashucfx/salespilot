...
public class MeetingController {
    ...
    public ResponseEntity<ApiResponse<MeetingDto>> scheduleMeeting(@Valid @RequestBody CreateMeetingRequest request, @AuthenticationPrincipal User user) {
    ...
    @GetMapping
    @org.springframework.security.access.prepost.PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<PageResponse<MeetingDto>>> getMyMeetings(@AuthenticationPrincipal User user, Pageable pageable) {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<Void>> cancelMeeting(@PathVariable UUID id, @AuthenticationPrincipal User user) {
        meetingService.cancelMeeting(id, user.getId());
        return ResponseEntity.ok(ApiResponse.<Void>success("Meeting cancelled successfully", null));
    }
